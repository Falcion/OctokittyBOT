    ...
    public class Handler : ModuleBase<SocketCommandContext> {
        ...
        public async Task ApiHelp() {
            ...
            EmbedBuilder messageEmbed = new EmbedBuilder()
                                                        ...
                                                        .AddField($"``{prefix}repos-info [repository author] [repository name]``", "Shows information about specified repository.")
                                                        .AddField($"``{prefix}repos-branches [repository author] [repository name]``", "Shows information about branches of specified repository.")
                                                        .AddField($"``{prefix}repos-releases [repository author] [repository name]``", "Shows information about releases of specified repository (includes page-system.)")
