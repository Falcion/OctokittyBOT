    ...
    public static class LangEnum
    {
        public static Language getLanguage(string? langName)
        {
            ...
            */
            ...
            string? argument = langName.ToLower();
        ...
        /* A method that returns a generic Language value that works for all types of requests. */
        ...
        /* A method that returns a static Language value that works for none of requests (system getter). */

        private static Language getStaticLang()
        {
            return new Language();
        }
    }
